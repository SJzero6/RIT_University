...
class TimeslotProvider with ChangeNotifier {
  ...
  Future<UpdateTimeSlot> updateFetchTimeSlots(
    ...
    final url =
        'http://tablet.panaceacloud.com:8216/RITApp/api/MobileApp/RitStudentDetails/DoctorAvailableTimeslots?from_date=$fromDate&to_date=$toDate&doctor_id=$doctorId';
